...
exports.checkChannelPerms = exports.v14Permissions = exports.v13Permissions = void 0;
const is_1 = require("./is");
exports.v13Permissions = {
...
function checkChannelPerms(channel, id, perms = 84992n) {
    return channel?.permissionsFor?.(id)?.has?.(is_1.is.undefined(perms) ? 84992n : perms) ?? false;
}
exports.checkChannelPerms = checkChannelPerms;
